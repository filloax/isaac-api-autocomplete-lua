...
---@return string[]
function Console.GetCommandHistory() end 
...
---@return string[]
function Console.GetHistory() end 

--- Removes previous lines from history. 
---@param amount number? Optional. The amount of lines to remove from the history. Default is one.
function Console.PopHistory(amount) end 

--- Prints an error to the console, errors display in red text.
---@param error string
function Console.PrintError(error) end

--- Prints a warning to the console, warnings display in yellow text.
---@param warning string
function Console.PrintWarning(warning) end
...
function Console.RegisterCommand(name, description, helpText, showOnMenu, autoCompleteType) end
...
function Console.RegisterMacro(name, commands) end
