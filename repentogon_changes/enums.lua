ModCallbacks.MC_PRE_ADD_COLLECTIBLE = 1004 -- (CollectibleType Type int Charge boolean FirstTime int Slot int VarData EntityPlayer Player) - Returning a CollectibleType overrides the collectible. You can also return a table of parameters to further modify the collectible given: {Type Charge FirstTime Slot VarData Player}
ModCallbacks.MC_POST_ADD_COLLECTIBLE = 1005 -- (CollectibleType Type int Charge boolean FirstTime int Slot int VarData EntityPlayer Player)
