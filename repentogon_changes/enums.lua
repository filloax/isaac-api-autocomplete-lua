	MC_PRE_ADD_COLLECTIBLE = 1004, -- (CollectibleType Type, int Charge, boolean FirstTime, int Slot, int VarData, EntityPlayer Player) - Returning a CollectibleType overrides the collectible. You can also return a table of parameters to further modify the collectible given: {Type, Charge, FirstTime, Slot, VarData, Player}
	MC_POST_ADD_COLLECTIBLE = 1005, -- (CollectibleType Type, int Charge, boolean FirstTime, int Slot, int VarData, EntityPlayer Player)
	MC_POST_TAKE_DMG = 1006,
	MC_POST_ENTITY_TAKE_DMG = 1006,
	MC_PRE_PLAYER_TAKE_DMG = 1008,
	MC_GRID_ROCK_UPDATE = 1010,
	...
	MC_PRE_GRID_INIT = 1100,
	MC_POST_GRID_INIT = 1101,
	...
	MC_PRE_PLAYER_APPLY_INNATE_COLLECTIBLE_NUM = 1092,
	MC_PRE_PLAYER_HAS_COLLECTIBLE = 1093,
